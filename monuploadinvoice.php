...
SELECT  kd_satker, kd_jns_spp, created_date, uraian, jml_pengeluaran nilai_rupiah, tgl_spp, sts_data  FROM SAKTI_APP.SPM_T_SPP where to_char(modified_date, 'yyyy-mm-dd') = to_char(sysdate, 'yyyy-mm-dd') and sts_data='SPM_STS_DATA_07') a left join
...
<table width='1470' border='1' align='center'>
   <caption><div align='center'> UPLOAD INVOICE </div></caption> 
<tbody>
