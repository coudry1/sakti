...
$sql  = oci_parse($conn, "select a.kppn_kd, b.nama_kppn, a.nama_file_sakti, a.tanggal_upload from (
select kppn_kd, nama_file_sakti, tanggal_upload FROM KONVERTERLV.POC_T_ADK 
WHERE TO_CHAR(TANGGAL_UPLOAD, 'YYYY-MON-DD') =  TO_CHAR (SYSTIMESTAMP, 'YYYY-MON-DD')) a left join
(select distinct kode_kppn, nama_kppn from KONVERTERLV.POC_R_KPPN) b on a.kppn_kd=b.kode_kppn" );
