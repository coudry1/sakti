...
$sql  = oci_parse($conn, "select a.kdsatker, b.deskripsi, a.kode_coa, a.pagu, a.realisasi_kom, a.realisasi_ben, realisasi_spm, a.realisasi_glp, a.sisa_pagu from (select substr(kode_coa,1,6) kdsatker, kode_coa, pagu, realisasi_kom, realisasi_ben, realisasi_spm, realisasi_glp, sisa_pagu from SAKTI_APP.GLP_T_FA_HEADER where substr(kode_coa,12,1)!='4' and substr(kode_coa,1,6)='$kdsatker' order by kode_coa) a left join
