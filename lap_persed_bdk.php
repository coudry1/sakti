...
<table height='50px' width='1280px' align='center' border='1'>
  <tr>
    <td align='center' width='5px'><strong>No. </strong></td>    
...
$sql  = oci_parse($conn, "select KODE_SATKER, NO_BAST, TGL_BAST, PROGRESS_PEKERJAAN, STATUS_DIBAYAR from SAKTI_APP.KOM_T_BAST_HEADER WHERE  ID_BAST IN (SELECT ID_BAST FROM SAKTI_APP.KOM_T_BAST_DETAIL WHERE IS_DICATAT = 0)");
oci_execute($sql);
