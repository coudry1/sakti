...
where substr(kode_akun,1,2)='52' and non_barang='1' and status_barang='0' and deleted='0'  and no_kwitansi not in(select no_bukti from sakti_app.PER_T_TRANS where asal_barang='KWITANSI') and kode_satker in ('527027','527031','527048','527052','531293','579330','015114','015117','613811','015116','015115') order by tgl_kwitansi,kode_satker");
