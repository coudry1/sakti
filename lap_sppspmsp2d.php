...
<div align='center'>
<form action="?p=lsss" method="post">
<select name="lsss" id="lsss" onChange="reload(this.form)">
...
$sql  = oci_parse($conn, "select e.Jenis_tagihan, e.created_date, e.uraian, e.nilai_rupiah , e.tgl_spp, e.no_spp, e.tgl_spm, e.no_spm,  e.tgl_sp2d, e.no_sp2d, e.stage from (
select c.kd_satker, d.deskripsi Jenis_tagihan, c.created_date,  c.uraian, c.nilai_rupiah, c.tgl_spp, c.no_spp, c.tgl_spm, c.no_spm,  c.tgl_sp2d, c.no_sp2d, c.stage from (
select a.kd_satker, a.kd_jns_spp, a.created_date, a.uraian, a.nilai_rupiah, a.tgl_spp, a.no_spp, a.tgl_spm, a.no_spm, a.tgl_sp2d, a.no_sp2d, b.deskripsi stage from (
SELECT  kd_satker, kd_jns_spp, created_date, uraian, jml_pengeluaran nilai_rupiah, tgl_spp, no_spp, tgl_spm, no_spm, tgl_sp2d, no_sp2d, sts_data  FROM SAKTI_APP.SPM_T_SPP where kd_satker='$kdsatker') a left join
...
(select kode, deskripsi from SAKTI_APP.ADM_R_SATKER) f on e.kd_satker=f.kode order by e.no_spp desc" );
oci_execute($sql);
...
<tr border='0' height='30px'><td colspan='11'align='center'>&nbsp;</td></tr>
<tr><td colspan='11'align='left'></td></tr>
<tr><td colspan='11' align='center'><strong>
MONITORING SPP/SPM/SP2D </strong></td></tr>
...
<table width='1280PX' border='1' align='center'>
<tbody>
    <tr><th>No.</th><th>Tanggal SPP</th><th>Nomor SPP</th><th>Tanggal SPM</th><th>Nomor SPM</th><th>Tanggal SP2D</th><th>Nomor SP2D</th><th>Jenis SPP</th><th>Nilai</th><th>Stage</th></tr>";
$no = 1;
while (($row1 = oci_fetch_array($sql, OCI_BOTH)) != false) {
    // Use the uppercase column names for the associative array indices
$NILAI=number_format($row1["NILAI_RUPIAH"],0,",",".");
$TAGIHAN=substr($row1["JENIS_TAGIHAN"], 0,12);
